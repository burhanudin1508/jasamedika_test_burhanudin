                    ...
                    <div class="content-header row">
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Data Pasien</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header d-flex justify-content-end pb-0">
                                                        <a href="{{route('pasien-add')}}" type="button"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($data as $item)
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $item->email }}</td>
                                                                            <td>{{ $item->alamat }}</td>
                                                                            <td>{{ $item->desa->nama_daerah }}</td>
                                                                            <td>{{ $item->kecamatan->nama_daerah }}</td>
                                                                            ...
                                                                            <td>
                                                                                <a href="{{ url('detail-pasien', \Crypt::encrypt($item->id)) }}"
                                                                                ...
                                                                                <a href="{{ url('update-pasien', \Crypt::encrypt($item->id)) }}"
                                                                                    id="edit-wilayah"
