        ...
        $('body').on('click', '#activate-wilayah', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "GET",
                        url: "{{ url('activate-provinsi') }}" + '/' + post_id,
                        success: function(data) {
                            $("#post_id_" + post_id).remove();
                            Swal.fire({
                                icon: 'success',
            ...
            $('body').on('click', '#delete-wilayah', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "GET",
                            url: "{{ url('delete-provinsi') }}" + '/' + post_id,
                            success: function(data) {
                                $("#post_id_" + post_id).remove();
                                Swal.fire({
                                    icon: 'success',
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-1">
                                        <input type="text" name="kode" id="kode" class="form-control"
                                            placeholder="Masukan Kode Wilayah" required="" disabled value="{{$kode_daerah}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="mb-1">
                                        <input type="text" name="nama" id="nama" class="form-control"
                                            placeholder="Masukan Nama Wilayah" required=""  disabled value="{{$nama_daerah}}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-header row">
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Data Kabupaten Kota Provinsi {{$nama_daerah}}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
